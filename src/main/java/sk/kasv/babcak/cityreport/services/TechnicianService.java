package sk.kasv.babcak.cityreport.services;
...
import sk.kasv.babcak.cityreport.models.Technician;
import sk.kasv.babcak.cityreport.repositories.DepartmentRepository;
import sk.kasv.babcak.cityreport.repositories.TechnicianRepository;
...
public class TechnicianService {
    ...
    public Technician createTechnician(Technician technician) {
        ...
        Department department = departmentRepository.findById(technician.getDepartment().getId())
                .orElseThrow(() -> new EntityNotFoundException("Department not found with id: " + technician.getDepartment().getId()));
    ...
    public Technician updateTechnician(Long id, Technician technicianDetails) {
        ...
        if (technicianDetails.getDepartment() != null && technicianDetails.getDepartment().getId() != null) {
            Department department = departmentRepository.findById(technicianDetails.getDepartment().getId())
                    .orElseThrow(() -> new EntityNotFoundException("Department not found with id: " + technicianDetails.getDepartment().getId()));
